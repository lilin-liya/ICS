...
# 1. Add the instruction IIADDL and ILEAVE into the pipe just like part B.

# 2. If the instruction is like:
#								mrmovl D(rA), rB
#   							rmmovl rB, D(rC)
...
#    It must be wrong. So I add juagement of e_valA in later's E stage,
#    when e_valA is transformmed.

# 3. I read other's code from the Internet,but I didn't just copy it.
#	 I learnt some optimaze ways from their code like the "2.".
#	 But I wrote my own code based on my understanding of their code.
#	 And I have done my best to get 8.50.
